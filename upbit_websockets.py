...
# - Desc : 업비트 웹소켓
# -----------------------------------------------------------------------------
async def upbit_ws_client(items):
        ...
        async with websockets.connect(upbit.ws_url) as websocket:
            ...
            while True:
                ...
                if debug_flag is True:
                    logging.info(data['cd'] + ":" + str(data['tp']))
                    # debug_flag = False
                ...
                #     re_subscribe_items = subscribe_items
                #     logging.info('\n\n')
                #     logging.info('*************************************************')
                ...
                #         time.sleep(1)
                #         await upbit_ws_client(subscribe_items)
